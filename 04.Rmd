...
Staying with `marginal_effects()` allows users some flexibility for customizing the plot(s). For example, the default behavior is depict the trajectory in terms of its 95% intervals and posterior median. If you'd prefer the 80% intervals and the posterior mean, customize it like so.
...
We'll explore more options with `brms::marginal_effects()` in a bit.
...
plot(me, 
     points = T, 
     point_args = list(size = 1/4, alpha = 1/4, width = .2, height = .075),
     plot = FALSE)[[1]] + 
