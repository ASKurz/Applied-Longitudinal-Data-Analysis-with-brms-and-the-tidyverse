...
We do not use the AIC or the BIC within the **Stan** ecosystem. The AIC is frequentist and cannot handle models with priors. The BIC is interesting is it’s a double misnomer. It is neither Bayesian nor is it a proper information criterion—though it does scale like one. However, it might be useful to walk out the ACI a bit. It'll ground our discussion of more recent advances. From [Spiegelhalter, Best, Carlin and van der Linde (2014)](https://www.jstor.org/stable/pdf/24774528.pdf?casa_token=cOkknddLwBsAAAAA:nwbGR1IDJtZHzGmhEUDJBLfELsSJUzgTR_r5j_gur7goLCihSBVdFhXeCZVxGKbj0B0Dr_4dZs52PsP4NEoFAM0M5OR7LusQSqGgGuyX147xIButrjzT), we read:
