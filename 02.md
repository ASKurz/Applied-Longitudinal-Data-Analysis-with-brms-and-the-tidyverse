...
These are the data shown in the top of Figure 2.1.
...
```
    ...
    ## Intercept     1.90      0.71     0.62     3.21 1.00     7585     3600
    ## time          0.12      0.30    -0.42     0.63 1.00     8259     3881
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.67      0.68     0.21     2.41 1.00     2370     2265
    ## 
...
standard error you might from an OLS output (i.e., from base **R**
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     1.16      0.57     0.42     1.91 1.00     7407     3215
    ## time          0.17      0.23    -0.14     0.47 1.00     7441     3525
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.38      0.54     0.11     1.41 1.00     1697     1244
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## R2 0.6206102 0.2501015 0.009876894 0.8148574
...
```
    ...
    ##  num [1:16000, 1] 0.0617 0.8144 0.3204 0.2436 0.7765 ...
...
![](02_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
```
    ...
    ##        mean    median      mode
    ## 1 0.6206102 0.7461008 0.7992798
...
```
    ...
    ##   <dbl>         <dbl>        <dbl>           <dbl>          <dbl>
    ## 1     9          1.88         0.72            0.12          0.3  
    ## 2    45          1.15         0.44            0.17          0.17 
    ## 3   268          1.52         0.69            0.03          0.290
    ## 4   314          1.31         0.43           -0.03          0.18 
    ## 5   442          1.57         0.6             0.06          0.25 
...
Next, we’ll extract our Bayesian \(R^2\) summaries. Given how nonnormal
...
| ---: | --------------: | -------------: | ----------------: | ---------------: | -----------------: | ---: | ---: | -------: |
|    9 |            1.88 |           0.72 |              0.12 |             0.30 |               0.44 | 0.34 |    0 |     1.54 |
|   45 |            1.15 |           0.44 |              0.17 |             0.17 |               0.13 | 0.75 |    1 |     1.16 |
|  268 |            1.52 |           0.69 |              0.03 |             0.29 |               0.47 | 0.20 |    1 |     0.90 |
|  314 |            1.31 |           0.43 |            \-0.03 |             0.18 |               0.17 | 0.22 |    0 |     0.81 |
|  442 |            1.57 |           0.60 |              0.06 |             0.25 |               0.30 | 0.25 |    0 |     1.13 |
|  514 |            1.43 |           0.41 |              0.27 |             0.17 |               0.13 | 0.86 |    1 |     0.90 |
|  569 |            1.81 |           0.09 |              0.05 |             0.04 |               0.01 | 0.85 |    0 |     1.99 |
|  624 |            1.12 |           0.15 |              0.02 |             0.06 |               0.01 | 0.36 |    1 |     0.98 |
|  723 |            1.27 |           0.27 |            \-0.05 |             0.11 |               0.06 | 0.45 |    0 |     0.81 |
|  918 |            1.01 |           0.86 |              0.14 |             0.34 |               0.65 | 0.34 |    0 |     1.21 |
|  949 |            1.74 |           0.69 |            \-0.10 |             0.29 |               0.43 | 0.31 |    1 |     0.93 |
|  978 |            1.02 |           0.81 |              0.64 |             0.34 |               0.65 | 0.87 |    1 |     1.59 |
| 1105 |            1.53 |           0.42 |              0.16 |             0.18 |               0.15 | 0.67 |    1 |     1.38 |
| 1542 |            1.19 |           0.49 |              0.24 |             0.20 |               0.22 | 0.75 |    0 |     1.44 |
| 1552 |            1.19 |           1.04 |              0.16 |             0.43 |               0.90 | 0.30 |    0 |     1.04 |
| 1653 |            0.95 |           0.46 |              0.24 |             0.18 |               0.15 | 0.84 |    0 |     1.25 |
...
![](02_files/figure-gfm/unnamed-chunk-35-1.png)<!-- -->
...
![](02_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     1.36      0.09     1.18     1.54 1.00    13266    11025
    ## time          0.13      0.04     0.06     0.21 1.00    13473    10874
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.47      0.04     0.40     0.55 1.00    13970    11706
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ##            Estimate  Est.Error       Q2.5     Q97.5
    ## Intercept 1.3569369 0.09166299 1.17680385 1.5367523
    ## time      0.1311133 0.03747172 0.05667398 0.2052411
...
![](02_files/figure-gfm/unnamed-chunk-42-1.png)<!-- -->
...
```
    ...
    ## Population-Level Effects: 
    ##           Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## Intercept     1.36      0.12     1.12     1.59 1.00     9140    11206
    ## time          0.10      0.05     0.01     0.20 1.00     8839    10102
    ## male          0.01      0.18    -0.35     0.37 1.00     7631     9946
    ## time:male     0.06      0.07    -0.08     0.21 1.00     7220     8890
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.47      0.04     0.40     0.55 1.00    12540    11051
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
```
    ...
    ## Intercept            1.39      0.12     1.15     1.64 1.00     7427
    ## time                 0.04      0.05    -0.05     0.14 1.00     7390
    ## exposure_01         -0.07      0.17    -0.40     0.26 1.00     6692
    ## time:exposure_01     0.18      0.07     0.04     0.31 1.00     6444
    ##                  Tail_ESS
    ## Intercept            9826
    ## time                 9923
    ## exposure_01          9555
    ## time:exposure_01     8573
    ## 
    ## Family Specific Parameters: 
    ##       Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS Tail_ESS
    ## sigma     0.43      0.04     0.37     0.51 1.00    12987    11594
    ## 
    ## Samples were drawn using sampling(NUTS). For each parameter, Eff.Sample 
    ## is a crude measure of effective sample size, and Rhat is the potential 
    ## scale reduction factor on split chains (at convergence, Rhat = 1).
...
![](02_files/figure-gfm/unnamed-chunk-53-1.png)<!-- -->
...
![](02_files/figure-gfm/unnamed-chunk-54-1.png)<!-- -->
...
![](02_files/figure-gfm/unnamed-chunk-55-1.png)<!-- -->
...
![](02_files/figure-gfm/unnamed-chunk-56-1.png)<!-- -->
...
```
    ...
    ##  [1] patchwork_1.0.0 brms_2.10.3     Rcpp_1.0.2      forcats_0.4.0  
    ...
    ##  [31] cli_1.1.0                 later_1.0.0              
    ##  [33] htmltools_0.4.0           prettyunits_1.0.2        
    ##  [35] tools_3.6.0               igraph_1.2.4.1           
    ##  [37] coda_0.19-3               gtable_0.3.0             
    ##  [39] glue_1.3.1.9000           reshape2_1.4.3           
    ##  [41] cellranger_1.1.0          vctrs_0.2.0              
    ##  [43] nlme_3.1-139              crosstalk_1.0.0          
    ##  [45] psych_1.8.12              xfun_0.10                
    ##  [47] ps_1.3.0                  rvest_0.3.4              
    ##  [49] mime_0.7                  miniUI_0.1.1.1           
    ##  [51] lifecycle_0.1.0           tidybayes_1.1.0          
    ##  [53] gtools_3.8.1              zoo_1.8-6                
    ##  [55] scales_1.0.0              colourpicker_1.0         
    ##  [57] hms_0.4.2                 promises_1.1.0           
    ##  [59] Brobdingnag_1.2-6         parallel_3.6.0           
    ##  [61] inline_0.3.15             shinystan_2.5.0          
    ##  [63] yaml_2.2.0                curl_4.2                 
    ##  [65] gridExtra_2.3             loo_2.1.0                
    ##  [67] StanHeaders_2.19.0        stringi_1.4.3            
    ##  [69] highr_0.8                 dygraphs_1.1.1.6         
    ##  [71] pkgbuild_1.0.5            rlang_0.4.1              
    ##  [73] pkgconfig_2.0.3           matrixStats_0.55.0       
    ##  [75] evaluate_0.14             lattice_0.20-38          
    ##  [77] rstantools_2.0.0          htmlwidgets_1.5          
    ##  [79] labeling_0.3              tidyselect_0.2.5         
    ##  [81] processx_3.4.1            plyr_1.8.4               
    ##  [83] magrittr_1.5              R6_2.4.0                 
    ##  [85] generics_0.0.2            pillar_1.4.2             
    ##  [87] haven_2.1.0               foreign_0.8-71           
    ##  [89] withr_2.1.2               xts_0.11-2               
    ##  [91] abind_1.4-5               modelr_0.1.4             
    ##  [93] crayon_1.3.4              arrayhelpers_1.0-20160527
    ##  [95] utf8_1.1.4                rmarkdown_1.13           
    ##  [97] grid_3.6.0                readxl_1.3.1             
    ##  [99] callr_3.3.2               threejs_0.3.1            
    ## [101] digest_0.6.21             xtable_1.8-4             
    ## [103] httpuv_1.5.2              stats4_3.6.0             
