...
You probably heard somewhere that Bayesian statistics require priors. We
...
```
    ...
    ##  [16] xml2_1.3.1           bridgesampling_1.0-0 splines_3.6.3       
    ##  [19] mnormt_1.5-6         knitr_1.28           shinythemes_1.1.2   
    ##  [22] bayesplot_1.7.1      jsonlite_1.6.1       broom_0.5.5         
    ##  [25] dbplyr_1.4.2         shiny_1.4.0.2        compiler_3.6.3      
    ##  [28] httr_1.4.1           backports_1.1.6      assertthat_0.2.1    
    ##  [31] Matrix_1.2-18        fastmap_1.0.1        cli_2.0.2           
    ##  [34] later_1.0.0          prettyunits_1.1.1    htmltools_0.4.0     
    ##  [37] tools_3.6.3          igraph_1.2.5         coda_0.19-3         
    ##  [40] gtable_0.3.0         glue_1.4.0           reshape2_1.4.4      
    ##  [43] cellranger_1.1.0     vctrs_0.2.4          nlme_3.1-144        
    ##  [46] crosstalk_1.1.0.1    psych_1.9.12.31      xfun_0.13           
    ##  [49] ps_1.3.2             rvest_0.3.5          mime_0.9            
    ##  [52] miniUI_0.1.1.1       lifecycle_0.2.0      tidybayes_2.0.3     
    ...
    ##  [67] gridExtra_2.3        StanHeaders_2.21.0-1 loo_2.2.0           
    ...
    ##  [82] tidyselect_1.0.0     processx_3.4.2       plyr_1.8.6          
    ##  [85] magrittr_1.5         R6_2.4.1             generics_0.0.2      
    ##  [88] DBI_1.1.0            pillar_1.4.3         haven_2.2.0         
    ##  [91] withr_2.1.2          mgcv_1.8-31          xts_0.12-0          
    ##  [94] abind_1.4-5          modelr_0.1.6         crayon_1.3.4        
    ##  [97] arrayhelpers_1.1-0   utf8_1.1.4           rmarkdown_2.1       
    ## [100] grid_3.6.3           readxl_1.3.1         callr_3.4.3         
    ## [103] threejs_0.3.3        reprex_0.3.0         digest_0.6.25       
    ## [106] xtable_1.8-4         httpuv_1.5.2         stats4_3.6.3        
    ## [109] munsell_0.5.0        viridisLite_0.3.0    shinyjs_1.1
