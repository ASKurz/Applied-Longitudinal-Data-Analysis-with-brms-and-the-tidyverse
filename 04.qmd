...
>
> $$\text{Composite residual: } [ \zeta_{0i} +  \zeta_{1i} \text{age\_14}_{ij} + \epsilon_{ij} ].$$
...
## Methods of estimation, revisited {#sec-Methods-of-estimation-revisited}
...
```{r, fig.width = 2.5, fig.height = 3, message = F}
...
```{r, fig.height = 3.25, fig.width = 6, warning = F}
