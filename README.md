...
You can find drafts of several of the chapters available as an online book at [https://solomon.quarto.pub/alda/](https://solomon.quarto.pub/alda/). The `.qmd` files with drafts included in the online book are listed in the [root directory](https://github.com/ASKurz/Applied-Longitudinal-Data-Analysis-with-brms-and-the-tidyverse) of this GitHub repository. You can find the `.qmd` files for chapters under development in the [in_the_works](https://github.com/ASKurz/Applied-Longitudinal-Data-Analysis-with-brms-and-the-tidyverse/tree/master/in_the_works) folder. 
