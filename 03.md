...
If you want to extract the intercepts from the `tidy` column, you might do this.
...
If you want the residual variances (i.e., *σ*<sub>*ϵ*</sub><sup>2</sup>), you'd `unnest()` the `glance` column. They'll be listed in the `sigma` column.
