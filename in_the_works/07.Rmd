...
fit7.2 <-
  brm(data = opposites_pp, 
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4,
      seed = 7,
      file = "/Users/solomonkurz/Dropbox/Recoding Applied Longitudinal Data Analysis/fits/fit07.02")
...
So far in this chapter, only the first model `fit7.1` used the conventional **brms** multilevel syntax, such as `(1 + time | id)`. The other five models used the `unstr()`, `cosy()`, or `ar()` helper functions, instead. In a sense then, `fit7.1` is the only multilevel model we've fit so far in this chapter. You might think of all the others as special kinds of multivariate panel models. To help make this more clear, let's first fit a simplified version of the unstructured model, following the form
...
fit7.7 <-
  brm(data = opposites_pp, 
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4,
      seed = 7,
      file = "/Users/solomonkurz/Dropbox/Recoding Applied Longitudinal Data Analysis/fits/fit07.07")
```
...
fit7.8 <-
  brm(data = opposites_wide, 
      ...
      iter = 2000, warmup = 1000, chains = 4, cores = 4,
      seed = 7,
      file = "/Users/solomonkurz/Dropbox/Recoding Applied Longitudinal Data Analysis/fits/fit07.08")
```
...
fit7.7b <-
  brm(data = opposites_pp, 
      ...
      seed = 7,
      file = "/Users/solomonkurz/Dropbox/Recoding Applied Longitudinal Data Analysis/fits/fit07.07b")
...
fit7.8b <-
  brm(data = opposites_wide, 
      ...
      iter = 13500, warmup = 1000, chains = 4, cores = 4,
      seed = 7,
      file = "/Users/solomonkurz/Dropbox/Recoding Applied Longitudinal Data Analysis/fits/fit07.08b")
```
